  ...
  <FeatureGrid
    features={[
      ...
      },
      {
        ...
        title: "Sync Status",
        description:
          "Renders a sync status icon with tooltip. Displays synchronization state with colored icons for synced, syncing, pending, partially synced, outdated, and failed states.",
        href: "/?path=/docs/components-value-display-sync-status--documentation",
      },
      {
        icon: Person,
        title: "Person",
